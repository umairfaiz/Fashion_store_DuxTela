...
$(document).ready(function(){
	...
	//ONLOAD
	$("#preview_front").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png) ') ;
	$("#preview_back").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png) ') ;
        $("#preview_left").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_left.png) ') ;	
        $("#preview_right").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_right.png) ') ;
	...
	$("#preview_back,.color_pick,.default_samples,.custom_icon,.custom_font").addClass('dis_none') ;
        $("#preview_left,.color_pick,.default_samples,.custom_icon,.custom_font").addClass('dis_none') ;
        $("#preview_right,.color_pick,.default_samples,.custom_icon,.custom_font").addClass('dis_none') ;
	...
	$("#o_front").click(function(){
		$y_pos="front";
				$("#preview_front").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
                                $("#o_left").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_left.png');
				$("#o_right").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_right.png');
                                $("#preview_front").removeClass('dis_none') ;
				$("#preview_back").addClass('dis_none') ;
                                $("#preview_right").addClass('dis_none') ;
                                $("#preview_left").addClass('dis_none') ;
		
	});
	$("#o_back").click(function(){
		$y_pos="back";
				$("#preview_back").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
                                $("#o_left").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_left.png');
				$("#o_right").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_right.png');
        ...
        $("#o_left").click(function(){
		$y_pos="left";
				$("#preview_left").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
				$("#o_left").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_left.png');
				$("#o_right").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_right.png');
				$("#preview_left").removeClass('dis_none') ;
                                $("#preview_front").addClass('dis_none') ;
				$("#preview_back").addClass('dis_none') ;
                                $("#preview_right").addClass('dis_none') ;
		
	});
        $("#o_right").click(function(){
		$y_pos="right";
				$("#preview_right").css('background-image', 'url(customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
				$("#o_left").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_left.png');
				$("#o_right").attr('src','customization/tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_right.png');
				$("#preview_right").removeClass('dis_none') ;
                                $("#preview_front").addClass('dis_none') ;
				$("#preview_back").addClass('dis_none') ;
                                $("#preview_left").addClass('dis_none') ;
...
/*=====================SAMPLE ICONS========================*/
	...
	$(".folder_toggle").click(function(){
		...
		$.ajax({
			      url: 'customization/tdesignAPI/control/newcontent.php?folder='+$folder,
			      success: function()
		      	{
		        	$("#toggle_show"+$i ).empty().load("customization/tdesignAPI/control/newcontent.php?folder="+$folder);
		      	}
	    });
	});
/*=====================SAMPLE ICONS over========================*/
...
$('.close_img').click(function(){
        //Next four line was added due to increase in web page
	$("#preview_front").removeClass('dis_none') ;
        $("#preview_back").addClass('dis_none') ;
        $("#preview_left").addClass('dis_none') ;
	$("#preview_right").addClass('dis_none') ;
	...
	//$('#preview_back').show();
        ...
        html2canvas($('#preview_right'), {
            onrendered: function(canvas) {
                document.getElementById("image_reply").appendChild(canvas);
				//Set hidden field's value to image data (base-64 string)
				$('#img_right').val(canvas.toDataURL("image/png"));
            }
        });
}
