...
<script type="text/javascript" src="customization/tdesignAPI/js/html2canvas.js"></script>

<script src="customization/tdesignAPI/js/jquery.form.js"></script>
<script src="customization/tdesignAPI/js/mainapp.js"></script>
<link rel="stylesheet" href="customization/tdesignAPI/css/jquery-ui.css" />
<script src="customization/tdesignAPI/js/jquery-ui.js"></script>
...
<div class="container design_api_container">
    <div class='design_api'>
        ...
        <div id='options'>
            <div class="T_type">
                <div id="radio1" ><img src="customization/tdesignAPI/images/menu_icons/submenu/tee.jpg" width="100%" height="100%" />
                </div>
                <div id="radio2" ><img src="customization/tdesignAPI/images/menu_icons/submenu/collar.jpg" width="100%" height="100%" />
                </div>
                <div id="radio3" ><img src="customization/tdesignAPI/images/menu_icons/submenu/hoodie.jpg" width="100%" height="100%" />
                </div>
            </div>
            ...
            <div class="default_samples">
                ...
                <?php
                $dir = 'customization/tdesignAPI/images/Images';
                $files1 = scandir($dir);
                //$files2 = scandir($dir, 1);
                foreach ($files1 as &$value) {
                    if (strpos($value, '.png') !== false) {
                        //echo 'true';
                        echo '<div class="sample_icons"><img src="customization/tdesignAPI/images/Images/' . $value . '" width="100%" height="100%" /></div>';
                    } elseif (strpos($value, '.') === false) {
                        //echo '<div class="sample_icons"><img src="customization/tdesignAPI/images/folder.png" width="100%" height="100%" />' .$value. '</div>' ;
                    }
                    //echo "Value: $value<br />\n";
                }
                ?>
        ...
        <div id='view_mode'>
            <div  class="mode"><img id="o_front" src="customization/tdesignAPI/images/product/tee/black/black_front.png" width="100%" height="80%" />FRONT
            </div>
            <div  class="mode"><img id="o_back" src="customization/tdesignAPI/images/product/tee/black/black_back.png" width="100%" height="80%" />BACK
            </div>
            <div  class="mode"><img id="o_left" src="customization/tdesignAPI/images/product/tee/black/black_left.png" width="100%" height="80%" />LEFT
            </div>
            <div  class="mode"><img id="o_right" src="customization/tdesignAPI/images/product/tee/black/black_right.png" width="100%" height="80%" />RIGHT
            </div>
        </div>
        <!--=====================View Ends========================================-->
        <div id="overview">
    ...
    <div class="layer">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" style="color: #3fc35f;text-align:center">Preview</h3>
            </div>
