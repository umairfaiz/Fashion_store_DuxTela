...
<html lang="en">
    <head>
        ...
        <title>Dux Tela | Add products</title>
                            ...
                            <div class="aa-product-details-content">
                                <div class="row">
                                    <form method="POST" action="addProduct.php" enctype="multipart/form-data" >
                                        <!-- Modal view content -->
                                        <h2>Add / Delete products</h2><br>
                                        <div class="col-md-6">
                                            <div class="aa-product-view-content">
                                                <div class="aa-prod-view-size">
                                                    <label >Category:</label><br/>
                                                    <input type="radio" name="item_cate" value="men">Men 
                                                    <input type="radio" name="item_cate" value="women"> Women
                                                    <input type="radio" name="item_cate" value="customize"> Customization<br/><br/>
                                                    <label >Item Image 1: (Dimension 250 * 300 pixels)</label><br/>
                                                    <input type="file" name="file1"/><br/>
                                                    <label >Item Image 2: (Dimension 250 * 300 pixels)</label><br/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="aa-product-view-content">
                                                <div class="aa-prod-view-size">
                                                    <label >Item Image 3: (Dimension 250 * 300 pixels)</label><br/>
                                                    <input type="file" name="file3"/><br/>
                                                    <label >Item Image 4: (Dimension 250 * 300 pixels)</label><br/>
                                        ...
                                        <div class="aa-prod-view-bottom">
                                            ...
                                            <button type="submit"  name="submit" class="aa-add-to-cart-btn" >Add Product</button>
                                            <a class="aa-add-to-cart-btn" href="edit_products.php">Edit products</a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="item_img1" value="<?php echo $row['itemimg1']; ?>"/>
                                                    <input type="hidden" name="item_img2" value="<?php echo $row['itemimg2']; ?>"/>
                                                    <input type="hidden" name="item_img3" value="<?php echo $row['itemimg3']; ?>"/>
                                                    <input type="hidden" name="item_img4" value="<?php echo $row['itemimg4']; ?>"/>
                                                    <input type="hidden" name="item_cate" value="<?php echo $row['itemCategory']; ?>"/>
                                                </tr>
                                                </form>
                                            </tbody>
                                                <?php
