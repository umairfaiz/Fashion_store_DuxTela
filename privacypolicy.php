...
<html>
    ...
    <body>
        <?php
                                      include("header.php");
                                   ?><br>
                                   <div align="center"><h1>Privacy Policy</h1><br></div>


<p>Effective date: July 27, 2018</p>


<p>Duxtela ("us", "we", or "our") operates the https://duxtela.com/ website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for Duxtela is powered by <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">FreePrivacyPolicy.com</a>.</p>
...
<p>Duxtela uses the collected data for various purposes:</p>    
<ul>
...
<p>Duxtela will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>Duxtela may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Duxtela</li>
...
<ul>
        <li>By email: info@duxtela.com</li>
            <li>By visiting this page on our website: https://duxtela.com/contact.php</li>
      
        <li>By phone number: +94-70-270-6900</li>
        </ul>        
<br><br>
<?php
                                      include("footer.php");
